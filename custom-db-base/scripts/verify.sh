...
grep -q '../_volumes/custom-db-base/worker1' "$compose" || fail "missing per-lab worker1 bind mount"
grep -q '../_volumes/custom-db-base/bus' "$compose" || fail "missing per-lab bus bind mount"
